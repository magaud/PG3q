...
(* P13 P0 *)
Lemma is_collineations_descr_B_P13_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P0 -> In (fp,fl) all_c182.
Proof.
...
(* P13 P1 *)
Lemma is_collineations_descr_B_P13_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P1 -> In (fp,fl) all_c183.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P2 *)
Lemma is_collineations_descr_B_P13_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P2 -> In (fp,fl) all_c184.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P3 *)
Lemma is_collineations_descr_B_P13_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P3 -> In (fp,fl) all_c185.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P4 *)
Lemma is_collineations_descr_B_P13_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P4 -> In (fp,fl) all_c186.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P5 *)
Lemma is_collineations_descr_B_P13_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P5 -> In (fp,fl) all_c187.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P6 *)
Lemma is_collineations_descr_B_P13_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P6 -> In (fp,fl) all_c188.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P7 *)
Lemma is_collineations_descr_B_P13_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P7 -> In (fp,fl) all_c189.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P8 *)
Lemma is_collineations_descr_B_P13_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P8 -> In (fp,fl) all_c190.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P9 *)
Lemma is_collineations_descr_B_P13_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P9 -> In (fp,fl) all_c191.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P10 *)
Lemma is_collineations_descr_B_P13_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P10 -> In (fp,fl) all_c192.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P11 *)
Lemma is_collineations_descr_B_P13_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P11 -> In (fp,fl) all_c193.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P12 *)
Lemma is_collineations_descr_B_P13_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P12 -> In (fp,fl) all_c194.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P13 P14 *)
Lemma is_collineations_descr_B_P13_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> fp P1 = P14 -> In (fp,fl) all_c195.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P13 -> In (fp,fl) (all_c182++all_c183++all_c184++all_c185++all_c186++all_c187++all_c188++all_c189++all_c190++all_c191++all_c192++all_c193++all_c194++all_c195).
Proof.
  ...
  left; apply is_collineations_descr_B_P13_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P13_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P13_P2; assumption.
  do 3 right; left; apply is_collineations_descr_B_P13_P3; assumption.
  do 4 right; left; apply is_collineations_descr_B_P13_P4; assumption.
  do 5 right; left; apply is_collineations_descr_B_P13_P5; assumption.
  do 6 right; left; apply is_collineations_descr_B_P13_P6; assumption.
  do 7 right; left; apply is_collineations_descr_B_P13_P7; assumption.
  do 8 right; left; apply is_collineations_descr_B_P13_P8; assumption.
  do 9 right; left; apply is_collineations_descr_B_P13_P9; assumption.
  do 10 right; left; apply is_collineations_descr_B_P13_P10; assumption.
  do 11 right; left; apply is_collineations_descr_B_P13_P11; assumption.
  do 12 right; left; apply is_collineations_descr_B_P13_P12; assumption.
  do 13 right; apply is_collineations_descr_B_P13_P14; assumption.
Qed.
