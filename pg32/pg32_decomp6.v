...
(* P6 P0 *)
Lemma is_collineations_descr_B_P6_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P0 -> In (fp,fl) all_c84.
Proof.
...
(* P6 P1 *)
Lemma is_collineations_descr_B_P6_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P1 -> In (fp,fl) all_c85.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P2 *)
Lemma is_collineations_descr_B_P6_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P2 -> In (fp,fl) all_c86.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P3 *)
Lemma is_collineations_descr_B_P6_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P3 -> In (fp,fl) all_c87.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P4 *)
Lemma is_collineations_descr_B_P6_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P4 -> In (fp,fl) all_c88.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P5 *)
Lemma is_collineations_descr_B_P6_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P5 -> In (fp,fl) all_c89.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P7 *)
Lemma is_collineations_descr_B_P6_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P7 -> In (fp,fl) all_c90.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P8 *)
Lemma is_collineations_descr_B_P6_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P8 -> In (fp,fl) all_c91.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P9 *)
Lemma is_collineations_descr_B_P6_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P9 -> In (fp,fl) all_c92.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P10 *)
Lemma is_collineations_descr_B_P6_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P10 -> In (fp,fl) all_c93.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P11 *)
Lemma is_collineations_descr_B_P6_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P11 -> In (fp,fl) all_c94.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P12 *)
Lemma is_collineations_descr_B_P6_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P12 -> In (fp,fl) all_c95.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P13 *)
Lemma is_collineations_descr_B_P6_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P13 -> In (fp,fl) all_c96.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P6 P14 *)
Lemma is_collineations_descr_B_P6_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> fp P1 = P14 -> In (fp,fl) all_c97.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P6 -> In (fp,fl) (all_c84++all_c85++all_c86++all_c87++all_c88++all_c89++all_c90++all_c91++all_c92++all_c93++all_c94++all_c95++all_c96++all_c97).
Proof.
  ...
  left; apply is_collineations_descr_B_P6_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P6_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P6_P2; assumption.
  do 3 right; left; apply is_collineations_descr_B_P6_P3; assumption.
  do 4 right; left; apply is_collineations_descr_B_P6_P4; assumption.
  do 5 right; left; apply is_collineations_descr_B_P6_P5; assumption.
  do 6 right; left; apply is_collineations_descr_B_P6_P7; assumption.
  do 7 right; left; apply is_collineations_descr_B_P6_P8; assumption.
  do 8 right; left; apply is_collineations_descr_B_P6_P9; assumption.
  do 9 right; left; apply is_collineations_descr_B_P6_P10; assumption.
  do 10 right; left; apply is_collineations_descr_B_P6_P11; assumption.
  do 11 right; left; apply is_collineations_descr_B_P6_P12; assumption.
  do 12 right; left; apply is_collineations_descr_B_P6_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P6_P14; assumption.
Qed.
