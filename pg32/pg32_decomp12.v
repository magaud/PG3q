...
(* P12 P0 *)
Lemma is_collineations_descr_B_P12_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P0 -> In (fp,fl) all_c168.
Proof.
...
(* P12 P1 *)
Lemma is_collineations_descr_B_P12_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P1 -> In (fp,fl) all_c169.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P2 *)
Lemma is_collineations_descr_B_P12_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P2 -> In (fp,fl) all_c170.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P3 *)
Lemma is_collineations_descr_B_P12_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P3 -> In (fp,fl) all_c171.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P4 *)
Lemma is_collineations_descr_B_P12_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P4 -> In (fp,fl) all_c172.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P5 *)
Lemma is_collineations_descr_B_P12_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P5 -> In (fp,fl) all_c173.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P6 *)
Lemma is_collineations_descr_B_P12_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P6 -> In (fp,fl) all_c174.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P7 *)
Lemma is_collineations_descr_B_P12_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P7 -> In (fp,fl) all_c175.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P8 *)
Lemma is_collineations_descr_B_P12_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P8 -> In (fp,fl) all_c176.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P9 *)
Lemma is_collineations_descr_B_P12_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P9 -> In (fp,fl) all_c177.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P10 *)
Lemma is_collineations_descr_B_P12_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P10 -> In (fp,fl) all_c178.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P11 *)
Lemma is_collineations_descr_B_P12_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P11 -> In (fp,fl) all_c179.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P13 *)
Lemma is_collineations_descr_B_P12_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P13 -> In (fp,fl) all_c180.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P12 P14 *)
Lemma is_collineations_descr_B_P12_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> fp P1 = P14 -> In (fp,fl) all_c181.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P12 -> In (fp,fl) (all_c168++all_c169++all_c170++all_c171++all_c172++all_c173++all_c174++all_c175++all_c176++all_c177++all_c178++all_c179++all_c180++all_c181).
Proof.
  ...
  left; apply is_collineations_descr_B_P12_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P12_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P12_P2; assumption.
  do 3 right; left; apply is_collineations_descr_B_P12_P3; assumption.
  do 4 right; left; apply is_collineations_descr_B_P12_P4; assumption.
  do 5 right; left; apply is_collineations_descr_B_P12_P5; assumption.
  do 6 right; left; apply is_collineations_descr_B_P12_P6; assumption.
  do 7 right; left; apply is_collineations_descr_B_P12_P7; assumption.
  do 8 right; left; apply is_collineations_descr_B_P12_P8; assumption.
  do 9 right; left; apply is_collineations_descr_B_P12_P9; assumption.
  do 10 right; left; apply is_collineations_descr_B_P12_P10; assumption.
  do 11 right; left; apply is_collineations_descr_B_P12_P11; assumption.
  do 12 right; left; apply is_collineations_descr_B_P12_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P12_P14; assumption.
Qed.
