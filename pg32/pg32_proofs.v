...
(*Ltac exists_lppp l t u v := exists l; exists t; exists u; exists v; unfold Intersect_In; simpl; reflexivity.*)
  ...
  Lemma a3_3_simple :
   ...
   Proof.
     ...
     case v1;(*case v2; intros hp1p2; try apply (@degen_bool _ hp1p2) ; case v3;
  intros hp1p3 hdist x;(* unfold f_a3_3 in x; *)try (apply (@degen_bool _ hp1p3)); try (apply (@degen_bool _ hdist));exists_lppp (fst x) (fst (fst (snd x))) (snd (fst (snd x))) (snd (snd x)).*)
