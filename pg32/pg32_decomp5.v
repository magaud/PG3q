...
(* P5 P0 *)
Lemma is_collineations_descr_B_P5_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P0 -> In (fp,fl) all_c70.
Proof.
...
(* P5 P1 *)
Lemma is_collineations_descr_B_P5_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P1 -> In (fp,fl) all_c71.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P2 *)
Lemma is_collineations_descr_B_P5_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P2 -> In (fp,fl) all_c72.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P3 *)
Lemma is_collineations_descr_B_P5_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P3 -> In (fp,fl) all_c73.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P4 *)
Lemma is_collineations_descr_B_P5_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P4 -> In (fp,fl) all_c74.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P6 *)
Lemma is_collineations_descr_B_P5_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P6 -> In (fp,fl) all_c75.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P7 *)
Lemma is_collineations_descr_B_P5_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P7 -> In (fp,fl) all_c76.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P8 *)
Lemma is_collineations_descr_B_P5_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P8 -> In (fp,fl) all_c77.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P9 *)
Lemma is_collineations_descr_B_P5_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P9 -> In (fp,fl) all_c78.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P10 *)
Lemma is_collineations_descr_B_P5_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P10 -> In (fp,fl) all_c79.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P11 *)
Lemma is_collineations_descr_B_P5_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P11 -> In (fp,fl) all_c80.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P12 *)
Lemma is_collineations_descr_B_P5_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P12 -> In (fp,fl) all_c81.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P13 *)
Lemma is_collineations_descr_B_P5_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P13 -> In (fp,fl) all_c82.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P5 P14 *)
Lemma is_collineations_descr_B_P5_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> fp P1 = P14 -> In (fp,fl) all_c83.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P5 -> In (fp,fl) (all_c70++all_c71++all_c72++all_c73++all_c74++all_c75++all_c76++all_c77++all_c78++all_c79++all_c80++all_c81++all_c82++all_c83).
Proof.
  ...
  left; apply is_collineations_descr_B_P5_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P5_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P5_P2; assumption.
  do 3 right; left; apply is_collineations_descr_B_P5_P3; assumption.
  do 4 right; left; apply is_collineations_descr_B_P5_P4; assumption.
  do 5 right; left; apply is_collineations_descr_B_P5_P6; assumption.
  do 6 right; left; apply is_collineations_descr_B_P5_P7; assumption.
  do 7 right; left; apply is_collineations_descr_B_P5_P8; assumption.
  do 8 right; left; apply is_collineations_descr_B_P5_P9; assumption.
  do 9 right; left; apply is_collineations_descr_B_P5_P10; assumption.
  do 10 right; left; apply is_collineations_descr_B_P5_P11; assumption.
  do 11 right; left; apply is_collineations_descr_B_P5_P12; assumption.
  do 12 right; left; apply is_collineations_descr_B_P5_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P5_P14; assumption.
Qed.
