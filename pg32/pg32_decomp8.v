...
(* P8 P0 *)
Lemma is_collineations_descr_B_P8_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P0 -> In (fp,fl) all_c112.
Proof.
...
(* P8 P1 *)
Lemma is_collineations_descr_B_P8_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P1 -> In (fp,fl) all_c113.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P8_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P2 -> In (fp,fl) all_c114.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P3 *)
Lemma is_collineations_descr_B_P8_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P3 -> In (fp,fl) all_c115.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P4 *)
Lemma is_collineations_descr_B_P8_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P4 -> In (fp,fl) all_c116.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P5 *)
Lemma is_collineations_descr_B_P8_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P5 -> In (fp,fl) all_c117.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P6 *)
Lemma is_collineations_descr_B_P8_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P6 -> In (fp,fl) all_c118.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P7 *)
Lemma is_collineations_descr_B_P8_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P7 -> In (fp,fl) all_c119.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P9 *)
Lemma is_collineations_descr_B_P8_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P9 -> In (fp,fl) all_c120.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P10 *)
Lemma is_collineations_descr_B_P8_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P10 -> In (fp,fl) all_c121.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P11 *)
Lemma is_collineations_descr_B_P8_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P11 -> In (fp,fl) all_c122.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P12 *)
Lemma is_collineations_descr_B_P8_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P12 -> In (fp,fl) all_c123.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P13 *)
Lemma is_collineations_descr_B_P8_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P13 -> In (fp,fl) all_c124.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P8 P14 *)
Lemma is_collineations_descr_B_P8_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> fp P1 = P14 -> In (fp,fl) all_c125.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P8 -> In (fp,fl) (all_c112++all_c113++all_c114++all_c115++all_c116++all_c117++all_c118++all_c119++all_c120++all_c121++all_c122++all_c123++all_c124++all_c125).
Proof.
  ...
  left; apply is_collineations_descr_B_P8_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P8_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P8_P2; assumption.
  do 3 right; left; apply is_collineations_descr_B_P8_P3; assumption.
  do 4 right; left; apply is_collineations_descr_B_P8_P4; assumption.
  do 5 right; left; apply is_collineations_descr_B_P8_P5; assumption.
  do 6 right; left; apply is_collineations_descr_B_P8_P6; assumption.
  do 7 right; left; apply is_collineations_descr_B_P8_P7; assumption.
  do 8 right; left; apply is_collineations_descr_B_P8_P9; assumption.
  do 9 right; left; apply is_collineations_descr_B_P8_P10; assumption.
  do 10 right; left; apply is_collineations_descr_B_P8_P11; assumption.
  do 11 right; left; apply is_collineations_descr_B_P8_P12; assumption.
  do 12 right; left; apply is_collineations_descr_B_P8_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P8_P14; assumption.
Qed.
