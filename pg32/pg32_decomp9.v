...
Lemma is_collineations_descr_B_P9_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P0 -> In (fp,fl) all_c126.
Proof.
...
Lemma is_collineations_descr_B_P9_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P1 -> In (fp,fl) all_c127.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P2 -> In (fp,fl) all_c128.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P3 -> In (fp,fl) all_c129.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P4 -> In (fp,fl) all_c130.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P5 -> In (fp,fl) all_c131.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P6 -> In (fp,fl) all_c132.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P7 -> In (fp,fl) all_c133.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P8 -> In (fp,fl) all_c134.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P10 -> In (fp,fl) all_c135.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P11 -> In (fp,fl) all_c136.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P12 -> In (fp,fl) all_c137.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P13 -> In (fp,fl) all_c138.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> fp P1 = P14 -> In (fp,fl) all_c139.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P9 -> In (fp,fl) (all_c126++all_c127++all_c128++all_c129++all_c130++all_c131++all_c132++all_c133++all_c134++all_c135++all_c136++all_c137++all_c138++all_c139).
Proof.
