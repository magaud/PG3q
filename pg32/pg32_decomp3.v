...
Lemma is_collineations_descr_B_P3_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P0 -> In (fp,fl) all_c42.
Proof.
...
Lemma is_collineations_descr_B_P3_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P1 -> In (fp,fl) all_c43.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P2 -> In (fp,fl) all_c44.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P4 -> In (fp,fl) all_c45.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P5 -> In (fp,fl) all_c46.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P6 -> In (fp,fl) all_c47.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P7 -> In (fp,fl) all_c48.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P8 -> In (fp,fl) all_c49.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P9 -> In (fp,fl) all_c50.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P10 -> In (fp,fl) all_c51.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P11 -> In (fp,fl) all_c52.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P12 -> In (fp,fl) all_c53.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P13 -> In (fp,fl) all_c54.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> fp P1 = P14 -> In (fp,fl) all_c55.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P3 -> In (fp,fl) (all_c42++all_c43++all_c44++all_c45++all_c46++all_c47++all_c48++all_c49++all_c50++all_c51++all_c52++all_c53++all_c54++all_c55).
Proof.
