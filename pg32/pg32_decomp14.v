...
(* P14 P0 *)
Lemma is_collineations_descr_B_P14_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P0 -> In (fp,fl) all_c196.
Proof.
...
(* P14 P1 *)
Lemma is_collineations_descr_B_P14_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P1 -> In (fp,fl) all_c197.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P2 *)
Lemma is_collineations_descr_B_P14_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P2 -> In (fp,fl) all_c198.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P3 *)
Lemma is_collineations_descr_B_P14_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P3 -> In (fp,fl) all_c199.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P4 *)
Lemma is_collineations_descr_B_P14_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P4 -> In (fp,fl) all_c200.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P5 *)
Lemma is_collineations_descr_B_P14_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P5 -> In (fp,fl) all_c201.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P6 *)
Lemma is_collineations_descr_B_P14_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P6 -> In (fp,fl) all_c202.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P7 *)
Lemma is_collineations_descr_B_P14_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P7 -> In (fp,fl) all_c203.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P8 *)
Lemma is_collineations_descr_B_P14_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P8 -> In (fp,fl) all_c204.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P9 *)
Lemma is_collineations_descr_B_P14_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P9 -> In (fp,fl) all_c205.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P10 *)
Lemma is_collineations_descr_B_P14_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P10 -> In (fp,fl) all_c206.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P11 *)
Lemma is_collineations_descr_B_P14_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P11 -> In (fp,fl) all_c207.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P12 *)
Lemma is_collineations_descr_B_P14_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P12 -> In (fp,fl) all_c208.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P14 P13 *)
Lemma is_collineations_descr_B_P14_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> fp P1 = P13 -> In (fp,fl) all_c209.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P14 -> In (fp,fl) (all_c196++all_c197++all_c198++all_c199++all_c200++all_c201++all_c202++all_c203++all_c204++all_c205++all_c206++all_c207++all_c208++all_c209).
Proof.
  ...
  left; apply is_collineations_descr_B_P14_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P14_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P14_P2; assumption.
  do 3 right; left; apply is_collineations_descr_B_P14_P3; assumption.
  do 4 right; left; apply is_collineations_descr_B_P14_P4; assumption.
  do 5 right; left; apply is_collineations_descr_B_P14_P5; assumption.
  do 6 right; left; apply is_collineations_descr_B_P14_P6; assumption.
  do 7 right; left; apply is_collineations_descr_B_P14_P7; assumption.
  do 8 right; left; apply is_collineations_descr_B_P14_P8; assumption.
  do 9 right; left; apply is_collineations_descr_B_P14_P9; assumption.
  do 10 right; left; apply is_collineations_descr_B_P14_P10; assumption.
  do 11 right; left; apply is_collineations_descr_B_P14_P11; assumption.
  do 12 right; left; apply is_collineations_descr_B_P14_P12; assumption.
  do 13 right; apply is_collineations_descr_B_P14_P13; assumption.
Qed.
