...
(* P10 P0 *)
Lemma is_collineations_descr_B_P10_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P0 -> In (fp,fl) all_c140.
Proof.
...
(* P10 P1 *)
Lemma is_collineations_descr_B_P10_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P1 -> In (fp,fl) all_c141.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P2 *)
Lemma is_collineations_descr_B_P10_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P2 -> In (fp,fl) all_c142.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P3 *)
Lemma is_collineations_descr_B_P10_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P3 -> In (fp,fl) all_c143.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P4 *)
Lemma is_collineations_descr_B_P10_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P4 -> In (fp,fl) all_c144.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P5 *)
Lemma is_collineations_descr_B_P10_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P5 -> In (fp,fl) all_c145.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P6 *)
Lemma is_collineations_descr_B_P10_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P6 -> In (fp,fl) all_c146.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P7 *)
Lemma is_collineations_descr_B_P10_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P7 -> In (fp,fl) all_c147.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P8 *)
Lemma is_collineations_descr_B_P10_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P8 -> In (fp,fl) all_c148.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P9 *)
Lemma is_collineations_descr_B_P10_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P9 -> In (fp,fl) all_c149.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P11 *)
Lemma is_collineations_descr_B_P10_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P11 -> In (fp,fl) all_c150.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P12 *)
Lemma is_collineations_descr_B_P10_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P12 -> In (fp,fl) all_c151.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P13 *)
Lemma is_collineations_descr_B_P10_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P13 -> In (fp,fl) all_c152.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P10 P14 *)
Lemma is_collineations_descr_B_P10_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> fp P1 = P14 -> In (fp,fl) all_c153.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P10 -> In (fp,fl) (all_c140++all_c141++all_c142++all_c143++all_c144++all_c145++all_c146++all_c147++all_c148++all_c149++all_c150++all_c151++all_c152++all_c153).
Proof.
  ...
  left; apply is_collineations_descr_B_P10_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P10_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P10_P2; assumption.
  do 3 right; left; apply is_collineations_descr_B_P10_P3; assumption.
  do 4 right; left; apply is_collineations_descr_B_P10_P4; assumption.
  do 5 right; left; apply is_collineations_descr_B_P10_P5; assumption.
  do 6 right; left; apply is_collineations_descr_B_P10_P6; assumption.
  do 7 right; left; apply is_collineations_descr_B_P10_P7; assumption.
  do 8 right; left; apply is_collineations_descr_B_P10_P8; assumption.
  do 9 right; left; apply is_collineations_descr_B_P10_P9; assumption.
  do 10 right; left; apply is_collineations_descr_B_P10_P11; assumption.
  do 11 right; left; apply is_collineations_descr_B_P10_P12; assumption.
  do 12 right; left; apply is_collineations_descr_B_P10_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P10_P14; assumption.
Qed.
