...
(* P1 P0 *)
Lemma is_collineations_descr_B_P1_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P0 -> In (fp,fl) all_c14.
Proof.
...
(* P1 P2 *)
Lemma is_collineations_descr_B_P1_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P2 -> In (fp,fl) all_c15.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P3 *)
Lemma is_collineations_descr_B_P1_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P3 -> In (fp,fl) all_c16.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P4 *)
Lemma is_collineations_descr_B_P1_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P4 -> In (fp,fl) all_c17.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P5 *)
Lemma is_collineations_descr_B_P1_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P5 -> In (fp,fl) all_c18.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P6 *)
Lemma is_collineations_descr_B_P1_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P6 -> In (fp,fl) all_c19.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P7 *)
Lemma is_collineations_descr_B_P1_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P7 -> In (fp,fl) all_c20.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P8 *)
Lemma is_collineations_descr_B_P1_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P8 -> In (fp,fl) all_c21.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P9 *)
Lemma is_collineations_descr_B_P1_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P9 -> In (fp,fl) all_c22.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P10 *)
Lemma is_collineations_descr_B_P1_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P10 -> In (fp,fl) all_c23.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P11 *)
Lemma is_collineations_descr_B_P1_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P11 -> In (fp,fl) all_c24.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P12 *)
Lemma is_collineations_descr_B_P1_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P12 -> In (fp,fl) all_c25.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P13 *)
Lemma is_collineations_descr_B_P1_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P13 -> In (fp,fl) all_c26.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P1 P14 *)
Lemma is_collineations_descr_B_P1_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> fp P1 = P14 -> In (fp,fl) all_c27.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P1 -> In (fp,fl) (all_c14++all_c15++all_c16++all_c17++all_c18++all_c19++all_c20++all_c21++all_c22++all_c23++all_c24++all_c25++all_c26++all_c27).
Proof.
  ...
  left; apply is_collineations_descr_B_P1_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P1_P2; assumption.
  do 2 right; left; apply is_collineations_descr_B_P1_P3; assumption.
  do 3 right; left; apply is_collineations_descr_B_P1_P4; assumption.
  do 4 right; left; apply is_collineations_descr_B_P1_P5; assumption.
  do 5 right; left; apply is_collineations_descr_B_P1_P6; assumption.
  do 6 right; left; apply is_collineations_descr_B_P1_P7; assumption.
  do 7 right; left; apply is_collineations_descr_B_P1_P8; assumption.
  do 8 right; left; apply is_collineations_descr_B_P1_P9; assumption.
  do 9 right; left; apply is_collineations_descr_B_P1_P10; assumption.
  do 10 right; left; apply is_collineations_descr_B_P1_P11; assumption.
  do 11 right; left; apply is_collineations_descr_B_P1_P12; assumption.
  do 12 right; left; apply is_collineations_descr_B_P1_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P1_P14; assumption.
Qed.
