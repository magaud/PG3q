...
(* P11 P0 *)
Lemma is_collineations_descr_B_P11_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P0 -> In (fp,fl) all_c154.
Proof.
...
(* P11 P1 *)
Lemma is_collineations_descr_B_P11_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P1 -> In (fp,fl) all_c155.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P2 *)
Lemma is_collineations_descr_B_P11_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P2 -> In (fp,fl) all_c156.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P3 *)
Lemma is_collineations_descr_B_P11_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P3 -> In (fp,fl) all_c157.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P4 *)
Lemma is_collineations_descr_B_P11_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P4 -> In (fp,fl) all_c158.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P5 *)
Lemma is_collineations_descr_B_P11_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P5 -> In (fp,fl) all_c159.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P6 *)
Lemma is_collineations_descr_B_P11_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P6 -> In (fp,fl) all_c160.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P7 *)
Lemma is_collineations_descr_B_P11_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P7 -> In (fp,fl) all_c161.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P8 *)
Lemma is_collineations_descr_B_P11_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P8 -> In (fp,fl) all_c162.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P9 *)
Lemma is_collineations_descr_B_P11_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P9 -> In (fp,fl) all_c163.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P10 *)
Lemma is_collineations_descr_B_P11_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P10 -> In (fp,fl) all_c164.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P12 *)
Lemma is_collineations_descr_B_P11_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P12 -> In (fp,fl) all_c165.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P13 *)
Lemma is_collineations_descr_B_P11_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P13 -> In (fp,fl) all_c166.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P11 P14 *)
Lemma is_collineations_descr_B_P11_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> fp P1 = P14 -> In (fp,fl) all_c167.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P11 -> In (fp,fl) (all_c154++all_c155++all_c156++all_c157++all_c158++all_c159++all_c160++all_c161++all_c162++all_c163++all_c164++all_c165++all_c166++all_c167).
Proof.
  ...
  left; apply is_collineations_descr_B_P11_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P11_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P11_P2; assumption.
  do 3 right; left; apply is_collineations_descr_B_P11_P3; assumption.
  do 4 right; left; apply is_collineations_descr_B_P11_P4; assumption.
  do 5 right; left; apply is_collineations_descr_B_P11_P5; assumption.
  do 6 right; left; apply is_collineations_descr_B_P11_P6; assumption.
  do 7 right; left; apply is_collineations_descr_B_P11_P7; assumption.
  do 8 right; left; apply is_collineations_descr_B_P11_P8; assumption.
  do 9 right; left; apply is_collineations_descr_B_P11_P9; assumption.
  do 10 right; left; apply is_collineations_descr_B_P11_P10; assumption.
  do 11 right; left; apply is_collineations_descr_B_P11_P12; assumption.
  do 12 right; left; apply is_collineations_descr_B_P11_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P11_P14; assumption.
Qed.
