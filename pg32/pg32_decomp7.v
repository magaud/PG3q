...
(* P7 P0 *)
Lemma is_collineations_descr_B_P7_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P0 -> In (fp,fl) all_c98.
Proof.
...
(* P7 P1 *)
Lemma is_collineations_descr_B_P7_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P1 -> In (fp,fl) all_c99.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P2 *)
Lemma is_collineations_descr_B_P7_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P2 -> In (fp,fl) all_c100.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P3 *)
Lemma is_collineations_descr_B_P7_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P3 -> In (fp,fl) all_c101.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P4 *)
Lemma is_collineations_descr_B_P7_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P4 -> In (fp,fl) all_c102.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P5 *)
Lemma is_collineations_descr_B_P7_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P5 -> In (fp,fl) all_c103.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P6 *)
Lemma is_collineations_descr_B_P7_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P6 -> In (fp,fl) all_c104.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P8 *)
Lemma is_collineations_descr_B_P7_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P8 -> In (fp,fl) all_c105.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P9 *)
Lemma is_collineations_descr_B_P7_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P9 -> In (fp,fl) all_c106.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P10 *)
Lemma is_collineations_descr_B_P7_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P10 -> In (fp,fl) all_c107.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P11 *)
Lemma is_collineations_descr_B_P7_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P11 -> In (fp,fl) all_c108.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P12 *)
Lemma is_collineations_descr_B_P7_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P12 -> In (fp,fl) all_c109.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P13 *)
Lemma is_collineations_descr_B_P7_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P13 -> In (fp,fl) all_c110.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P7 P14 *)
Lemma is_collineations_descr_B_P7_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> fp P1 = P14 -> In (fp,fl) all_c111.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P7 -> In (fp,fl) (all_c98++all_c99++all_c100++all_c101++all_c102++all_c103++all_c104++all_c105++all_c106++all_c107++all_c108++all_c109++all_c110++all_c111).
Proof.
  ...
  left; apply is_collineations_descr_B_P7_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P7_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P7_P2; assumption.
  do 3 right; left; apply is_collineations_descr_B_P7_P3; assumption.
  do 4 right; left; apply is_collineations_descr_B_P7_P4; assumption.
  do 5 right; left; apply is_collineations_descr_B_P7_P5; assumption.
  do 6 right; left; apply is_collineations_descr_B_P7_P6; assumption.
  do 7 right; left; apply is_collineations_descr_B_P7_P8; assumption.
  do 8 right; left; apply is_collineations_descr_B_P7_P9; assumption.
  do 9 right; left; apply is_collineations_descr_B_P7_P10; assumption.
  do 10 right; left; apply is_collineations_descr_B_P7_P11; assumption.
  do 11 right; left; apply is_collineations_descr_B_P7_P12; assumption.
  do 12 right; left; apply is_collineations_descr_B_P7_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P7_P14; assumption.
Qed.
