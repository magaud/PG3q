...
(* P2 P0 *)
Lemma is_collineations_descr_B_P2_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P0 -> In (fp,fl) all_c28.
Proof.
...
(* P2 P1 *)
Lemma is_collineations_descr_B_P2_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P1 -> In (fp,fl) all_c29.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P3 *)
Lemma is_collineations_descr_B_P2_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P3 -> In (fp,fl) all_c30.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P4 *)
Lemma is_collineations_descr_B_P2_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P4 -> In (fp,fl) all_c31.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P5 *)
Lemma is_collineations_descr_B_P2_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P5 -> In (fp,fl) all_c32.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P6 *)
Lemma is_collineations_descr_B_P2_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P6 -> In (fp,fl) all_c33.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P7 *)
Lemma is_collineations_descr_B_P2_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P7 -> In (fp,fl) all_c34.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P8 *)
Lemma is_collineations_descr_B_P2_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P8 -> In (fp,fl) all_c35.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P9 *)
Lemma is_collineations_descr_B_P2_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P9 -> In (fp,fl) all_c36.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P10 *)
Lemma is_collineations_descr_B_P2_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P10 -> In (fp,fl) all_c37.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P11 *)
Lemma is_collineations_descr_B_P2_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P11 -> In (fp,fl) all_c38.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P12 *)
Lemma is_collineations_descr_B_P2_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P12 -> In (fp,fl) all_c39.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P13 *)
Lemma is_collineations_descr_B_P2_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P13 -> In (fp,fl) all_c40.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P2 P14 *)
Lemma is_collineations_descr_B_P2_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> fp P1 = P14 -> In (fp,fl) all_c41.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P2 -> In (fp,fl) (all_c28++all_c29++all_c30++all_c31++all_c32++all_c33++all_c34++all_c35++all_c36++all_c37++all_c38++all_c39++all_c40++all_c41).
Proof.
  ...
  left; apply is_collineations_descr_B_P2_P0; assumption.
  do 1 right; left; apply is_collineations_descr_B_P2_P1; assumption.
  do 2 right; left; apply is_collineations_descr_B_P2_P3; assumption.
  do 3 right; left; apply is_collineations_descr_B_P2_P4; assumption.
  do 4 right; left; apply is_collineations_descr_B_P2_P5; assumption.
  do 5 right; left; apply is_collineations_descr_B_P2_P6; assumption.
  do 6 right; left; apply is_collineations_descr_B_P2_P7; assumption.
  do 7 right; left; apply is_collineations_descr_B_P2_P8; assumption.
  do 8 right; left; apply is_collineations_descr_B_P2_P9; assumption.
  do 9 right; left; apply is_collineations_descr_B_P2_P10; assumption.
  do 10 right; left; apply is_collineations_descr_B_P2_P11; assumption.
  do 11 right; left; apply is_collineations_descr_B_P2_P12; assumption.
  do 12 right; left; apply is_collineations_descr_B_P2_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P2_P14; assumption.
Qed.
