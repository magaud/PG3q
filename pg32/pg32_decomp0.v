...
(* P0 P1 *)
Lemma is_collineations_descr_B_P0_P1 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P1 -> In (fp,fl) all_c0.
Proof.
...
(* P0 P2 *)
Lemma is_collineations_descr_B_P0_P2 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P2 -> In (fp,fl) all_c1.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P3 *)
Lemma is_collineations_descr_B_P0_P3 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P3 -> In (fp,fl) all_c2.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P4 *)
Lemma is_collineations_descr_B_P0_P4 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P4 -> In (fp,fl) all_c3.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P5 *)
Lemma is_collineations_descr_B_P0_P5 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P5 -> In (fp,fl) all_c4.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P6 *)
Lemma is_collineations_descr_B_P0_P6 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P6 -> In (fp,fl) all_c5.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P7 *)
Lemma is_collineations_descr_B_P0_P7 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P7 -> In (fp,fl) all_c6.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P8 *)
Lemma is_collineations_descr_B_P0_P8 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P8 -> In (fp,fl) all_c7.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P9 *)
Lemma is_collineations_descr_B_P0_P9 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P9 -> In (fp,fl) all_c8.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P10 *)
Lemma is_collineations_descr_B_P0_P10 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P10 -> In (fp,fl) all_c9.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P11 *)
Lemma is_collineations_descr_B_P0_P11 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P11 -> In (fp,fl) all_c10.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P12 *)
Lemma is_collineations_descr_B_P0_P12 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P12 -> In (fp,fl) all_c11.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P13 *)
Lemma is_collineations_descr_B_P0_P13 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P13 -> In (fp,fl) all_c12.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
(* P0 P14 *)
Lemma is_collineations_descr_B_P0_P14 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> fp P1 = P14 -> In (fp,fl) all_c13.
Proof.
  intros fp fl Hfpfl HP0 HP1.
    assert (HP0P1:(P0<>P1)) by discriminate;
    generalize (fp_lemma fp fl Hfpfl P0 P1 HP0P1); clear HP0P1; rewrite HP0; rewrite HP1; intros HP2; cbn in HP2; 
...
Lemma is_collineations_descr_B_P0 :
  forall fp fl, is_collineation fp fl -> fp P0 = P0 -> In (fp,fl) (all_c0++all_c1++all_c2++all_c3++all_c4++all_c5++all_c6++all_c7++all_c8++all_c9++all_c10++all_c11++all_c12++all_c13).
Proof.
  ...
  left; apply is_collineations_descr_B_P0_P1; assumption.
  do 1 right; left; apply is_collineations_descr_B_P0_P2; assumption.
  do 2 right; left; apply is_collineations_descr_B_P0_P3; assumption.
  do 3 right; left; apply is_collineations_descr_B_P0_P4; assumption.
  do 4 right; left; apply is_collineations_descr_B_P0_P5; assumption.
  do 5 right; left; apply is_collineations_descr_B_P0_P6; assumption.
  do 6 right; left; apply is_collineations_descr_B_P0_P7; assumption.
  do 7 right; left; apply is_collineations_descr_B_P0_P8; assumption.
  do 8 right; left; apply is_collineations_descr_B_P0_P9; assumption.
  do 9 right; left; apply is_collineations_descr_B_P0_P10; assumption.
  do 10 right; left; apply is_collineations_descr_B_P0_P11; assumption.
  do 11 right; left; apply is_collineations_descr_B_P0_P12; assumption.
  do 12 right; left; apply is_collineations_descr_B_P0_P13; assumption.
  do 13 right; apply is_collineations_descr_B_P0_P14; assumption.
Qed.
